    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden bg-beige">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 rounded-full glass-card px-4 py-1.5 text-xs uppercase tracking-[0.25em] text-gold mb-6 animate-fade-up">
            <Sparkles className="h-3.5 w-3.5" /> Enquire Today
          </div>
          <h1
            className="font-serif text-4xl md:text-6xl mb-4 animate-fade-up"
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 grid lg:grid-cols-5 gap-10">
        ...
        <aside className="lg:col-span-2 space-y-6">
          <div className="rounded-3xl bg-card border border-border shadow-luxe p-8">
            ...
            <ul className="space-y-5">
              <li className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:0419678189" className="text-foreground hover:text-gold">0419 678 189</a>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <span className="h-10 w-10 inline-flex items-center justify-center rounded-full gradient-gold text-ink flex-shrink-0">
                ...
                <div>
                  ...
                  <a href="mailto:elitemagicbooth@gmail.com" className="text-foreground hover:text-gold break-all">elitemagicbooth@gmail.com</a>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <span className="h-10 w-10 inline-flex items-center justify-center rounded-full gradient-gold text-ink flex-shrink-0">
            ...
            <div className="mt-8 pt-6 border-t border-border flex items-center gap-3">
              <a aria-label="Instagram" href="#" className="h-10 w-10 inline-flex items-center justify-center rounded-full bg-beige hover:bg-gold hover:text-ink transition">
                <Instagram className="h-4 w-4" />
              </a>
              <a aria-label="Facebook" href="#" className="h-10 w-10 inline-flex items-center justify-center rounded-full bg-beige hover:bg-gold hover:text-ink transition">
        ...
        <form
          onSubmit={onSubmit}
          className="lg:col-span-3 relative rounded-3xl bg-card/80 backdrop-blur-xl border border-border shadow-luxe p-8 md:p-10 space-y-5 animate-fade-up"
        >
          {submitted && (
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              <SelectField label="Package Interested In" name="package" options={packages.map((p) => p.name)} />
            </div>
          </div>
          ...
          <button
            disabled={submitting}
            type="submit"
            className="w-full inline-flex items-center justify-center rounded-full gradient-gold px-6 py-4 font-semibold text-ink shadow-luxe hover:scale-[1.02] transition-transform disabled:opacity-60"
          >
...
function Field({
  label, name, type = "text", required, maxLength,
