...
export function SiteHeader() {
  ...
  const linkClass = "text-white hover:text-[#d4af37] transition-colors";
  ...
  { href: "/#gallery", label: "Capturing Moments" },
            ...
            <Link
              to="/terms"
              onClick={() => setOpen(false)}
              className="py-3 px-2 rounded-xl text-white/80 hover:bg-white/5 hover:text-[#d4af37] transition text-sm"
            >
              Terms & Conditions
            </Link>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 md:py-16 grid md:grid-cols-3 gap-10 md:gap-12">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li><a href="/#gallery" className="hover:text-gold">Capturing Moments</a></li>
